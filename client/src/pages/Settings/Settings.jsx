    ...
    return (
        <div>
            ...
            <div style={{ marginBottom: '30px' }}>
                ...
                <p style={{ color: 'var(--text-muted)' }}>Manage your school's global information and configuration.</p>
            </div>

            <div className="premium-card" style={{ maxWidth: '800px' }}>
                <h2 style={{ fontSize: '18px', fontWeight: '600', marginBottom: '24px', paddingBottom: '16px', borderBottom: '1px solid var(--border-color)' }}>
                    School Information
                </h2>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '24px' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '10px' }}>
                        <button
                            ...
                            onMouseLeave={(e) => !saving && (e.target.style.backgroundColor = 'var(--primary-color)')}
                        >
                            <Save size={18} />
