...
const StudentDashboard = () => {
  ...
  useEffect(() => {
    const fetchDashboard = async () => {
      ...
      try {
        const [dashRes, gradesRes, attRes] = await Promise.all([
            ...
            >
              ...
              <div className="premium-card" style={{ padding: "24px" }}>
                ...
                >
                  ...
                  >
                    <Calendar size={20} color="var(--primary-color)" /> Today's
                    Classes
                  </h3>
                  <button
                    type="button"
                ...
                >
                  ...
                  <div>
                    ...
                    <p style={{ color: "#b91c1c", fontSize: "13px" }}>
                      You have {data?.assignmentsCount || 0} assignments due
                      this week. Don't forget to submit them!
                    </p>
                  </div>
                </div>
              )}
            ...
            >
                    ...
                    >
                      <div
                        style={{
                          ...
                          width: "3px",
                          backgroundColor:
                            item.priority === "high" ? "#ef4444" : "#e2e8f0",
                          borderRadius: "2px",
                        }}
                      ></div>
                      <p
                      ...
                      >
                        ...
                        <span
                          style={{
                            ...
                            borderRadius: "10px",
                            backgroundColor:
                              item.priority === "high" ? "#fef2f2" : "#f3f4f6",
                            color:
                              item.priority === "high" ? "#ef4444" : "#6b7280",
                            fontWeight: "600",
                          }}
                        >
              ...
              <div className="premium-card" style={{ padding: "24px" }}>
                ...
                >
                  ...
                  >
                    <TrendingUp size={20} color="#8b5cf6" /> My Grades
                  </h3>
                </div>
                    ...
                    grades.slice(0, 3).map((grade, idx) => (
                      ...
                      >
                        <div>
                          ...
                          >
                            by {grade.teacherId?.name || "Teacher"}
                          </p>
                        </div>
                        <div
                          style={{
              ...
              <div className="premium-card" style={{ padding: "24px" }}>
                ...
                >
                  ...
                  >
                    <Calendar size={20} color="#10b981" /> Attendance Summary
                  </h3>
                </div>
