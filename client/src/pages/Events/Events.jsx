...
const Events = () => {
    ...
    const columns = [
        ...
        { 
            header: 'Time', 
            render: (row) => new Date(row.date).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })
        },
    ...
    return (
        <div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px' }}>
                <div>
                    <h1 style={{ fontSize: '28px', marginBottom: '8px' }}>School Events</h1>
                    <p style={{ color: 'var(--text-muted)' }}>Manage and schedule school-wide events and activities.</p>
                </div>
                <button
                    onClick={handleAdd}
                    style={{
